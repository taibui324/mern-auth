...
export class Confirm extends Component {
    ...
    render() {
        const {
            values: { name, email, phone, password, facebook, instagram, zalo }
        } = this.props;
        ...
        return (
            <div className="form-container">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">Instagram URL: <a href={instagram}>{instagram}</a></li>
                    <li class="list-group-item">Zalo URL: <a href={zalo}>{zalo}</a></li>
                </ul>
